<template>
  <section
    ...
    <div class="sort-panel">
      <v-btn-group>
        <v-btn @click="sortCards('asc')" icon="mdi-sort-ascending" variant="tonal" color="white"></v-btn>
        <v-btn @click="sortCards('desc')" icon="mdi-sort-descending" variant="tonal" color="white"></v-btn>
        <v-btn @click="sortCards('none')" icon="mdi-sort-variant-remove" variant="tonal" color="white"></v-btn>
      </v-btn-group>
    </div>
